...
use_knmf_colours <- function(scales = TRUE, geom_defaults = TRUE){
  ...
  assign("scale_color_discrete", scale_color_discrete_knmf, pos = ggKNMF_colour_scales)
  ...
  assign("scale_color_continuous", scale_color_continuous_knmf, pos = ggKNMF_colour_scales)
  ...
  assign("scale_color_ordinal", scale_color_ordinal_knmf, pos = ggKNMF_colour_scales)
